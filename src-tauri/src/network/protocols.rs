...
/// Protocol scanning configuration
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ProtocolScanConfig {
    /// Protocols to scan
    pub protocols: Vec<Protocol>,
    /// Timeout for each protocol
    pub timeout_ms: u32,
    /// Retry attempts
    pub retries: u8,
    /// Parallel scanning
...
/// Protocol scanning result
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ProtocolScanResult {
    /// Scanned protocol
    pub protocol: Protocol,
    /// Is protocol supported/open
    pub supported: bool,
...
pub struct ProtocolDiscoveryResult {
    ...
    pub protocols: Vec<ProtocolScanResult>,
    /// Network interfaces where protocols were found
...
/// Protocol traversal configuration
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TraversalConfig {
    /// Protocols to use for traversal
    pub protocols: Vec<Protocol>,
    /// Maximum hops for traversal
    pub max_hops: u8,
    /// Timeout for traversal attempts
    pub timeout_ms: u32,
    /// Enable NAT traversal
    pub nat_traversal: bool,
    /// Enable firewall traversal
    pub firewall_traversal: bool,
    /// Use relay servers if direct traversal fails
    pub use_relays: bool,
}

/// Protocol traversal result
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TraversalResult {
    pub source: String,
    pub destination: String,
    pub path: Vec<String>,
    pub protocols_used: Vec<Protocol>,
    pub success: bool,
