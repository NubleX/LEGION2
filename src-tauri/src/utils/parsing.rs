...
impl NmapParser {
    ...
    // NOTE: XML parsing has been moved to xml_parser.rs to avoid duplication
    // Use XmlParser::parse_nmap_xml() for parsing XML files after scan completion
    // This module (parsing.rs) is now only for real-time line-by-line parsing
